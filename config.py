...
# Whether to use  instance level queries or not. These are duplicated for each frame at the start of the decoder, resulting in NUM_QUERIES for each frame instead of
# NUM_QUERIES / NUM_FRAMES
_C.MODEL.DEVIS.INSTANCE_LEVEL_QUERIES = False
...
_C.MODEL.LOSS.AUX_LOSS_WEIGHTING = True
